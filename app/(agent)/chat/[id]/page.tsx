          ...
          <div className="pt-2 border-t border-gray-50 space-y-1.5">
            ...
            {["Rent increase requested by landlord", "Lease type is fixed-term"].map((f) => (
              <div key={f} className="flex items-center gap-2 text-xs text-gray-700">
                <span className="w-2 h-2 rounded-full bg-green-400 shrink-0" />{f}
              </div>
            ))}
          </div>
          <div className="pt-2 border-t border-gray-50 space-y-1.5">
        ...
        <div className="space-y-2">
          ...
          {[
            ...
            <div key={s.title} className="flex items-center gap-2 px-2.5 py-2 bg-green-50 rounded-lg border border-green-100">
              <span className="w-5 h-5 rounded-full bg-green-200 text-green-700 text-[10px] font-bold flex items-center justify-center shrink-0">P{s.rank}</span>
    ...
    <div>
      ...
      >
        ...
        <div className="shrink-0 w-4 flex items-center justify-center">
          {isRunning && <Loader2 size={13} className="text-indigo-500 animate-spin" />}
        ...
        <Icon
          size={13}
          className={
            isPending ? "text-gray-200" : isDone ? "text-gray-400" : "text-indigo-500"
          }
        />
    ...
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      ...
      <div className="px-5 py-5 space-y-4 text-sm text-gray-700 leading-relaxed">
        <p>
          ...
          <strong>cannot increase rent during a fixed-term lease</strong> unless the lease
          agreement explicitly allows it — for example, through a CPI indexation clause or
          an agreed escalation schedule.
        </p>
        ...
        <div className="p-3 bg-red-50 rounded-xl border border-red-100">
          ...
          <p className="text-red-700 text-xs leading-relaxed">
            The rent increase is likely <strong>void under Danish law</strong>. You have the
            right to refuse it and may file a complaint with the local Rent Tribunal (
            <em>Huslejenævnet</em>).
          </p>
        </div>
...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50/80">
      ...
      <div className="border-t border-gray-200 bg-white/90 backdrop-blur-sm px-4 py-3">
